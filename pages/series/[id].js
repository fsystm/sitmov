...
const data = await fetch("https://api.npoint.io/59430877b2dad48ee2a1/sitmovAPI/");
...
export async function getStaticProps({ params }) {
   const data = await fetch(`https://api.npoint.io/59430877b2dad48ee2a1/sitmovAPI/${params.id}/`);
